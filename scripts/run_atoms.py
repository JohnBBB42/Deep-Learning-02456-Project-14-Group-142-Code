...
def configure_cli(default_job_name, add_trainer_args=True, add_data_args=True):
    ...
    cli.add_argument("--num_swag_samples", type=int, default=30, help="Number of SWAG samples to draw during prediction.")
    # SAM Arguments
    ...
    cli.add_argument('--num_laplace_samples', type=int, default=10, help='Number of weight samples during Laplace prediction.')
    cli.add_argument("--prior_precision", type=float, default=0.0, help="Prior precision to add during Laplace approximation.")
    if add_trainer_args:
        ...
        cli.link_arguments("num_swag_samples", "trainer.num_swag_samples", apply_on="parse")
        # Original
